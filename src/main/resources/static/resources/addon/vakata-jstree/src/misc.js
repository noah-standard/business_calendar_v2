...
(function (factory) {
	...
	if (typeof define === 'function' && define.amd) {
		define('jstree.node_customize', ['jquery','static/resources/addon/vakata-jstree/src/jstree'], factory);
	}
	else if(typeof exports === 'object') {
		factory(require('jquery'), require('static/resources/addon/vakata-jstree/src/jstree'));
	}
	else {
...
(function (factory) {
        "use strict";
        if (typeof define === 'function' && define.amd) {
                define('jstree.parentsload', ['jquery','static/resources/addon/vakata-jstree/src/jstree'], factory);
        }
        else if(typeof exports === 'object') {
                factory(require('jquery'), require('static/resources/addon/vakata-jstree/src/jstree'));
        }
...
(function (factory) {
	"use strict";
	if (typeof define === 'function' && define.amd) {
		define('jstree.conditionaldeselect', ['jquery','static/resources/addon/vakata-jstree/src/jstree'], factory);
	}
	else if(typeof exports === 'object') {
		factory(require('jquery'), require('static/resources/addon/vakata-jstree/src/jstree'));
	}
...
(function (factory) {
	"use strict";
	if (typeof define === 'function' && define.amd) {
		define('jstree.conditionalclose', ['jquery','static/resources/addon/vakata-jstree/src/jstree'], factory);
	}
	else if(typeof exports === 'object') {
		factory(require('jquery'), require('static/resources/addon/vakata-jstree/src/jstree'));
	}
